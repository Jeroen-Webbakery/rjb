...
{
    // Get the theme data
    wp_enqueue_style('child-understrap-styles', get_stylesheet_directory_uri() . '/assets/css/rjb.min.css', array(), filemtime(get_stylesheet_directory() . '/assets/css/rjb.min.css'), 'all');
    wp_enqueue_script('child-understrap-scripts', get_stylesheet_directory_uri() . '/assets/js/rjb.min.js', [ "jquery" ], filemtime(get_stylesheet_directory() . '/assets/js/rjb.min.js'), true);
