...
<div class="site" id="page">
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-6 col_left">
                        ...
                        <?php if (!has_custom_logo()) { ?>
                            ...
                            <?php else : ?>
                                <a class="navbar-brand d-none" rel="home" href="<?php echo esc_url(home_url('/')); ?>"
                    ...
                    <div class="col-sm-12 col-lg-6 d-none d-lg-block col_right"
                         style="background-image:url(<?php echo esc_url(get_field('afbeelding', 'option')); ?>)">
    ...
    <div class="menu_button">
        <div class="open">
            ...
            <svg class="open_icon" width="21px" height="15px" viewBox="0 0 21 15" version="1.1"
                ...
                <g id="Desktop" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round">
                    <g id="01_Home" transform="translate(-1378.000000, -40.000000)" stroke="#FEFEFE"
                       stroke-width="1.61290323">
                        <g id="icon-menu" transform="translate(1362.000000, 20.000000)">
                            <g id="Group-5" transform="translate(17.000000, 21.000000)">
                                <line x1="2" y1="0.5" x2="19" y2="0.5" id="Line"></line>
                                <line x1="7" y1="12.5" x2="19" y2="12.5" id="Line-Copy-2"></line>
                                <line x1="1.10574632e-16" y1="6.5" x2="19" y2="6.5" id="Line-Copy"></line>
                            </g>
                        </g>
                    </g>
                </g>
        ...
        <div class="close hide">
            <span>close</span>
            <svg class="close_icon hide" width="12px" height="12px" viewBox="0 0 12 12" version="1.1"
                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>Group 3</title>
                <g id="Desktop" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round"
                   stroke-linejoin="round">
                    <g id="02_Menu" transform="translate(-1385.000000, -41.000000)" stroke="#FEFEFE">
                        <g id="Group-6" transform="translate(1315.000000, 20.000000)">
                            <g id="Group-3" transform="translate(70.000000, 21.000000)">
                                <line x1="0.5" y1="11.5" x2="11.5" y2="0.5" id="Line-2"></line>
                                <line x1="0.5" y1="11.5" x2="11.5" y2="0.5" id="Line-2"
                                      transform="translate(6.000000, 6.000000) scale(-1, 1) translate(-6.000000, -6.000000) "></line>
                            </g>
                        </g>
                    </g>
                </g>
    ...
    <div id="start_screen">
        <svg id="start_logo" width="442px" height="65px" viewBox="0 0 442 65" version="1.1"
             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">

            <g id="Desktop" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="01_Home" transform="translate(-90.000000, -71.000000)" fill="#000000">
