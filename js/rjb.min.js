...
$(document).ready(function () {
  ...
  function homeSlider() {
    $('.header_slider').slick({
      ...
      slidesToScroll: 1,
      dots: false,
      arrows: false // prevArrow: $('.prev_header_slide'),
...
if ($.cookie('count') === '1') {
  var tl = new gsap_all__WEBPACK_IMPORTED_MODULE_3__.TimelineMax();
  tl.from($("#start_logo"), 2, {
    top: '55%',
    duration: 2,
    ease: "power3.out"
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 4:
                  scrollX = 0;
                  scrollY = 0;
                  _barba_core__WEBPACK_IMPORTED_MODULE_1___default().hooks.leave(function () {
                    scrollX = (_barba_core__WEBPACK_IMPORTED_MODULE_1___default().history.current.scroll.x);
                    scrollY = (_barba_core__WEBPACK_IMPORTED_MODULE_1___default().history.current.scroll.y);
                  });
                  window.scrollTo(scrollX, scrollY);
                  done();
                  _barba_core__WEBPACK_IMPORTED_MODULE_1___default().hooks.enter(function () {
                    function homeSlider() {
                      $('.header_slider').slick({
                        infinite: true,
                        autoplay: true,
...
/******/ 	__webpack_require__.O(undefined, ["css/aos.min","css/rjb.min"], () => (__webpack_require__("./js/rjb.js")))
/******/ 	__webpack_require__.O(undefined, ["css/aos.min","css/rjb.min"], () => (__webpack_require__("./sass/rjb/rjb.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/aos.min","css/rjb.min"], () => (__webpack_require__("./sass/rjb/aos.scss")))
